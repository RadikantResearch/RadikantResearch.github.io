...
function blocs_goToFirebase(){
	window.location.href = "radikant.nl/firebase/";
}
function blocs_goToTls(){
	window.location.href = "radikant.nl/tls/";
	playSoundFX("/audio/audio-sample.mp3");
}
function blocs_goToEvent(){
	window.location.href = "radikant.nl/event/";
}
function blocs_goToCrypto(){
	window.location.href = "radikant.nl/crypto/";
}
function blocs_newInteraction(){
	window.open("6400", "_blank");
}
function blocs_goToLog(){
	window.location.href = "radikant.nl/log/";
}
function blocs_goToSocket(){
	window.location.href = "radikant.nl/socket/";
}
function blocs_goBle(){
	window.location.href = "radikant.nl/ble/";
}
function blocs_goToJwt(){
	window.location.href = "radikant.nl/jwt/";
}
function blocs_goToMysql(){
	window.location.href = "radikant.nl/mysql/";
}
function blocs_gotoAsn1(){
	window.location.href = "radikant.nl/asn1/";
}
function blocs_goToUrl(){
	window.location.href = "radikant.nl/url/";
}
function blocs_goToJson(){
	window.location.href = "radikant.nl/json/";
}

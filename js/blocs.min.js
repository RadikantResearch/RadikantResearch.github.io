...
function blocs_goToFirebase(){
	window.location.href = "https://radikant.nl/firebase/";
}
function blocs_goToTls(){
	window.location.href = "https://radikant.nl/tls/";
	playSoundFX("/audio/audio-sample.mp3");
}
function blocs_goToEvent(){
	window.location.href = "https://radikant.nl/event/";
}
function blocs_goToCrypto(){
	window.location.href = "https://radikant.nl/crypto/";
}
function blocs_newInteraction(){
	window.open("6400", "_blank");
}
function blocs_goToLog(){
	window.location.href = "https://radikant.nl/log/";
}
function blocs_goToSocket(){
	window.location.href = "https://radikant.nl/socket/";
}
function blocs_goBle(){
	window.location.href = "https://radikant.nl/ble/";
}
function blocs_goToJwt(){
	window.location.href = "https://radikant.nl/jwt/";
}
function blocs_goToMysql(){
	window.location.href = "https://radikant.nl/mysql/";
}
function blocs_gotoAsn1(){
	window.location.href = "https://radikant.nl/asn1/";
}
function blocs_goToUrl(){
	window.location.href = "https://radikant.nl/url/";
}
function blocs_goToJson(){
	window.location.href = "https://radikant.nl/json/";
}
function blocs_newInteraction(){
}
function blocs_goToFlasher(){
	window.location.href = "https://radikant.nl/flasher/";
}
function blocs_goToPrinter(){
	window.location.href = "https://radikant.nl/printer/";
}
function blocs_goToNvs(){
	window.location.href = "https://radikant.nl/nvs/";
}
function blocs_goToCoap(){
	window.location.href = "https://radikant.nl/coap/";
}
function blocs_goToWebsocket(){
	window.open("https://radikant.nl/websocket/", "_blank");
}
function blocs_goToPocketbase(){
	window.open("https://radikant.nl/pocketbase/", "_blank");
}
function blocs_goToTrailbase(){
	window.open("https://radikant.nl/trailbase/", "_blank");
}
function blocs_goToSupabase(){
	window.open("https://radikant.nl/supabase/", "_blank");
}
function blocs_newInteraction(){
	window.open("https://radikant.nl/cert/", "_blank");
}
function blocs_goToCert(){
	window.open("https://radikant.nl/cert/", "_blank");
}
function blocs_goToBase64(){
	window.open("https:/radikant.nl", "_blank");
}
function blocs_goToPobe(){
	window.open("https://radikant.nl/probe/", "_blank");
}
function blocs_gotoSerial(){
	window.open("https://radikant.nl/serial/", "_blank");
}

const soundFXInstances = [];function playSoundFX(file) {const audio = new Audio(blocsResourcePath+file);soundFXInstances.push(audio);audio.play();}